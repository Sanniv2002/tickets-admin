        ...
        <>
          <div className="space-y-6">
            {attendees.map((attendee) => (
              <div
                key={attendee._id}
                className="bg-zinc-900 rounded-lg p-6 border-l-4 border-green-500"
              >
                <div className="flex justify-between items-start">
                  <div className="flex-1">
                    <h3 className="text-xl font-semibold text-white">{attendee.name}</h3>
                    <p className="text-gray-400">{attendee.email}</p>
                    <div className="mt-4 grid grid-cols-2 gap-4">
                      <div>
                        <p className="text-sm text-gray-400">Roll Number</p>
                        <p className="text-white">{attendee.rollNumber}</p>
                      </div>
                      <div>
                        <p className="text-sm text-gray-400">Contact</p>
                        <p className="text-white">{attendee.contactNumber}</p>
                      </div>
                      <div>
                        <p className="text-sm text-gray-400">Degree & Year</p>
                        <p className="text-white">{`${attendee.degree} - ${attendee.year}`}</p>
                      </div>
                      <div>
                        <p className="text-sm text-gray-400">Branch</p>
                        <p className="text-white">{attendee.branch}</p>
                      </div>
                    </div>
